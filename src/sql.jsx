    ...
    return (
        <div className="python-container">
            ...
            <p className="python-description">
                SQL is a popular, high-level, interpreted programming language known for its simplicity and readability.
            ...
            <div className="python-buttons">
                <button onClick={() => alert("Start Learning Python!")}>Learn SQL</button>
